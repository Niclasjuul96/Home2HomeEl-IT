...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form class="postFormBody" action="" method="post">
        <div class="form-group">
            <p class="labelBookIt">
                <label for="full_Name">Fulde navn</label>
            </p>
        ...
        <div class="form-group">
            <p class="labelBookIt">
                <label for="cell_Num">Telefon nummer</label>
            </p>
        ...
        <div class="form-group">
            <p class="labelBookIt">
                <label for="service_Choosen">Vælg service</label>
            </p>
        ...
        <div class="form-check">
            <label class="form-check-label" for="exampleCheck1">
                <input type="checkbox" class="form-check-input" name="user_Accept" id="exampleCheck1" required>
                Jeg har læst og forstået <a href="Garanti-og-Handelsvilkår.html" target="_blank">garanti og handelsvilkår</a>.
